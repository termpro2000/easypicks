        ...
        <div className="max-w-4xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">배송접수 시스템</h1>
                <p className="text-sm text-blue-600 font-medium">관리자화면</p>
              </div>
            </div>
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex justify-center gap-8">
            ...
            {/* 시스템설정 버튼 */}
            <button
              onClick={() => handleButtonClick('시스템설정')}
              className="w-48 h-48 bg-white rounded-3xl shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 flex flex-col items-center justify-center gap-4 group"
            >
              ...
              <div className="text-center">
                <h3 className="text-xl font-bold text-gray-900 mb-1">시스템설정</h3>
                <p className="text-sm text-gray-500">시스템을 설정합니다</p>
              </div>
            </button>
          </div>
        </div>
